    ...
    <>
      <div className='px-6 md:px-12 py-8 bg-[#2A254B] mt-8'>
        <div className="flex flex-wrap gap-12 md:gap-[100px] lg:gap-[200px]">
          ...
          <div className="text-white w-full sm:w-auto">
            <h1 className="text-lg md:text-xl ">Join our mailing list</h1>
            <div className='mt-4'>
              <input
                type="text"
                placeholder="your@email.com"
                className='w-full sm:w-[250px] lg:w-[300px] h-[48px] p-2 bg-[#F9F9F926] hover:bg-[#f9f9f941] opacity-35 border border-white rounded-md'
              />
...
//         <div className="flex justify-between md: flex-wrap gap-[100px] lg:gap-[200px]">
